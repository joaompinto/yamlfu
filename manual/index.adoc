...
Strings found between consecutive `($)` «dollar signs» will be processed as dynamic elements, their content is evaluated in a python runtime, the result of that evalution replaces the dynamic string.
